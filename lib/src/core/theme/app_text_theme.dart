...
//InputText Style
  static TextStyle inputTextStyle1 = GoogleFonts.aBeeZee(
      fontSize: 20, fontWeight: FontWeight.w300, color: AppColors.headingColor);
  // Button Style
  ...
  static var body = GoogleFonts.aBeeZee(
      textStyle: const TextStyle(fontSize: 17, fontWeight: FontWeight.w200,));
  static var quotes = GoogleFonts.aBeeZee(
      textStyle: const TextStyle(fontSize: 15, fontWeight: FontWeight.w200));
  static var body1 = GoogleFonts.aBeeZee(
